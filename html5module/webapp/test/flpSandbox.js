		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Final Project",
									"targetURL": "#logaligrouphtml5module-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouphtml5module-display": {
								"semanticObject": "logaligrouphtml5module",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.html5module",
									"url": sap.ui.require.toUrl("logaligroup/html5module")
								}
							}
						}
					}
