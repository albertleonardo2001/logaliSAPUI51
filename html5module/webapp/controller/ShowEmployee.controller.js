sap.ui.define([
	...
	function onRiseEmployee(oEvent){
		if(!this.riseDialog){
			...
			this.riseDialog = sap.ui.xmlfragment("logaligroup/html5module/fragment/RiseEmployee", this);
	...
	return Controller.extend("logaligroup.html5module.controller.ShowEmployee", {
		onInit: onInit,
